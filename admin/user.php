<?php
  ...
  if(isset($_GET['hal']))
  {
    if($_GET['hal']=="hapus")
    {
      $hapus=mysqli_query($conn, "DELETE FROM customer WHERE CustomerID ='$_GET[id]'");
      if($hapus)
      {
        echo "<script>
          ...
          <div class="col-md-10 p-5 pt-2">
              ...
              <table class="table table-striped table-bordered">
                ...
                <?php
                    ...
                    $tampil = mysqli_query($conn,"SELECT * FROM customer ORDER BY CustomerID asc");
                  ...
                  ?>
                   ...
                   <td><?=$data['CustomerID']?></td>
                    ...
                    <td><a href="user.php?hal=hapus&id=<?=$data['CustomerID']?>" onclick="return confirm('Apakah anda ingin menghapus data ini?')"><i class="fas fa-trash-alt bg-danger p-2 text-white rounded" data-toogle="tooltip" title="Delete"></i></a></td>
                    </tr>
                   <?php endwhile;?>
                </tbody>
                </table>
