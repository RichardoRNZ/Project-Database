    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-slide">
                <img src="assets/img/portfolio/tomat.jpg" alt="">
              </div>
          ...
          <?php
            include "koneksi.php";
            $tampil=mysqli_query($conn,"SELECT * FROM produk,kategori WHERE kategori.ID='CT001' AND Produk_Id='PR001'");
            ...
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Stock</strong>
                  ...
                  ?></li>
               <a href="cart.php?id=<?=$sql['Produk_Id']?>" class="btn btn-success margin : 10%">Tambahkan ke keranjang</a>
              </ul>
            </div>
